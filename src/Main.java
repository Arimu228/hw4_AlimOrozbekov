...
public class Main {
    ...
    public static int[] heroesHealth = {200, 260, 270};
    public static int[] heroesDamage = {25, 20, 15};

    public static int medicHealth = 200;
    public static int medicInfluence = 25;
    ...
    public static void playRound() {
        ...
        chooseBossDefence();
        bossHits();
        System.out.println("Medic's health: " + medicHealth);
        heroesHit();
    ...
    public static void medicine(){
        for (int i = 0; i < heroesHealth.length; i++) {
            if (heroesHealth[i] >0 && heroesHealth[i] <100){
                heroesHealth[i] = heroesHealth[i] + medicInfluence;
                break;
            }
        }
